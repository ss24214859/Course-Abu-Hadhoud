...
private:
    ...
    static vector<clsBankClient> _LoadClientsDataFromFile()
    {
        ...
        fstream MyFile;
        MyFile.open("Project3 Bank/Clients.txt", ios::in); // read Mode
    ...
    static void _SaveCleintsDataToFile(vector<clsBankClient> vClients)
    {
        ...
        fstream MyFile;
        MyFile.open("Project3 Bank/Clients.txt", ios::out); // overwrite
    ...
    {
        fstream MyFile;
        MyFile.open("Project3 Bank/Clients.txt", ios::out | ios::app);
...
public:
    ...
    void Print(clsBankClient Client)
    {
        Client.Print();
    }
