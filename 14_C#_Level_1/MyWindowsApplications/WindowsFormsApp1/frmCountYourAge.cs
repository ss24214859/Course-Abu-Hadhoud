...
namespace WindowsFormsApp1
{
    public partial class frmMaskedTextBox : Form
    {
        ...
        {
            lblDateTime.Text  = dateTimePicker1.Text.ToString() + Environment.NewLine;
            lblDateTime.Text += dateTimePicker1.Value.ToString("dd-MM-yyyy") + Environment.NewLine;
            lblAge.Text = CheckAgeFormDate(dateTimePicker1.Value.ToString());
        }
