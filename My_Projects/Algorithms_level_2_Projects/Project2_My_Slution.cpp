...
{
    short QuesLevel = ReadIntNumberBetween(1, 4, "Enter Question Level : Easy:[1],Med:[2],Hard:[3],Mix:[4] ? \n");
...
enOpType ReadOpType()
{
    enOpType OpType = enOpType(ReadIntNumberBetween(1, 5, "Enter Operation Type : Add:[1],Sub:[2],Mul:[3],Div:[4],Mix:[5] ?\n"));
    return OpType;
}
...
void StartExam()
{
    ...
    {
        ResetScreen();
        int HowManyQues = ReadIntNumberBetween(1, 10, "How Many Question Do You want To Answer? [1]To[10]?");
