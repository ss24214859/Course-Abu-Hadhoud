...
enum enWhopen{rock=1,pepper=2,scissor=3};
enum enWiner{NoWiner=0,Player1=1,Player2=2,};


void GetPlayersChoice(stPlayerInFo &Player1,stPlayerInFo &Player2)
{
    Player1.Whopen= (enWhopen)Random::RandomNumber(1,3);
    Player2.Whopen=(enWhopen)IO::ReadNumberInRang(1,3,"enter your choice? rock:[1],Pepper[2],scissor[3]?");
}
...
void startGame(stPlayerInFo &Player1,stPlayerInFo &Player2)
{
    system("CLS");
    system("color 0F");
    int NumberOfRounds=IO::ReadNumberInRang(1,10,"How Many Rounds [1] To [10] ?");
