...
short CountOodNumbersInArray(int array1[100],int arrLength1)
{
    int count=0;
    for(int i=0;i<arrLength1;i++)
    {
        if(ChackOodOrEven(array1[i])==enOodOrEven::ood)  //or ood=(array[i]%2 != 0) 
        count++;
    }
    return count;
}
...
int main()
{
    ...
    CountOodNumbersInArray(array,arrLength);
   
    cout<<"\nArray 1 ELements : \n";
    PrintArray(array,arrLength);
    cout<<"ood Numbers count in Array is : "<<CountOodNumbersInArray(array,arrLength);
