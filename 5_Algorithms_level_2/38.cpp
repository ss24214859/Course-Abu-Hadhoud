...
void CopyOodNumbersInArray(int array1[100],int array2[100],int arrLength1,int &arrLength2)
{
...
int main()
{
    ...
    int arrLength1=ReadNumber("enter number ? "),
    arrLength2=0;

    FillArrayWithRandomNumber(array1,arrLength1);

    CopyOodNumbersInArray(array1,array2,arrLength1,arrLength2);
